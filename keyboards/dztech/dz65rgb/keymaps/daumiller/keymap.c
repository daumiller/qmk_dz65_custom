...
* |-----------------------------------------------------------------------------|
* |CapsL   |  A |  S |  D |  F |  G |  H |  J |  K |  L |  ; |  ' |Return  |End |
* |-----------------------------------------------------------------------------|
* |Shift    |  Z |  X |  C |  V |  B |  N |  M |  , |  . |  / |Shift  | Up | ❌ |
* |-----------------------------------------------------------------------------|
* |Ctrl |Alt  |Cmd  |           Space            |Cmd | FN |  ❌ |Lef |Dow |Rig |
* `-----------------------------------------------------------------------------'
*/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_65_ansi(
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                               KC_SPC,                    KC_RGUI, MO(1),   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT_65_ansi(
    KC_TRNS,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_DEL,  KC_TRNS,
    KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_VAD, RGB_VAI, RGB_TOG, KC_TRNS, KC_PGUP,
